def gen_comb_list(list_set):
    ...
    # Recursively generate combinations of the remaining lists
    rest_combinations = gen_comb_list(list_set[1:])

    # Combine the current list with the rest of the combinations
    current_list = list_set[0]
    result = []
